...
<ParamField body="attendees[].name" type="string">
  Attendee display name.
</ParamField>

<ParamField body="attendees[].phone" type="string">
  Attendee phone number.
</ParamField>

<ParamField body="attendees[].email" type="string">
  Attendee email address.
</ParamField>

<ParamField body="attendees[].uniqueId" type="string">
  Your upstream identifier for the attendee, such as a CRM contact ID.
</ParamField>
